...
function RayfieldLibrary:CreateWindow(Settings)
	...
	function Window:CreateTab(Name, Image, Ext)
        ...
        TabButton.Interact.InputBegan:Connect(function(input)
    if input.UserInputType == Enum.UserInputType.MouseButton1 then
        ...
        CreateRipple(TabButton, Vector2.new(relativeX, relativeY))
    end
end)
...
if infoElement and infoElement ~= "" then
    ...
    InfoLabel.Visible = true
        ...
        CreateRipple(Button, Vector2.new(relativeX, relativeY))
    end
end)
...
if infoElement and infoElement ~= "" then
    ...
    Dropdown.Title.Position = UDim2.new(0, 110,0, 11)
    Dropdown.Title.Size = UDim2.new(0, 200,0, 14)
    
	InfoLabel.TextScaled = InputScaled
    InfoLabel.Position = UDim2.new(0, 150,0, 29)
    ...
    if input.UserInputType == Enum.UserInputType.MouseButton1 then
        ...
        CreateRipple(DropdownOption, Vector2.new(relativeX, relativeY))
    end
end)
...
if infoElement and infoElement ~= "" then
    ...
    if input.UserInputType == Enum.UserInputType.MouseButton1 then
        ...
        CreateRipple(Toggle, Vector2.new(relativeX, relativeY))
    end
end)
...
if infoElement and infoElement ~= "" then
	...
	InfoLabel.TextScaled = InputScaled
    InfoLabel.Position = UDim2.new(0, 12,0, 29)
    InfoLabel.Size = UDim2.new(0.35, -24,0.206, 12)
	...
	Slider.Main.Progress.BackgroundColor3 = Color3.fromRGB(170, 170, 170)
	Slider.Main.Progress.UIStroke.Color = Color3.fromRGB(170, 170, 170)
	Slider.Title.Size = UDim2.new(0, 120,0, 14)
	...
	InputBox.PlaceholderText = "Input Value..."
...
function Tab:CreateCollapsible(CollapsibleSettings)
    ...
    local function UpdateContainerSize()
        ...
        if childCount > 1 then
            totalHeight = totalHeight + ((childCount - 1) * 10)
        end
...
DropdownOption.Interact.MouseButton1Click:Connect(function()
	...
	-- ✅ Update the displayed text correctly
	if DropdownSettings.MultipleOptions then
		if #DropdownSettings.CurrentOption == 1 then
			Dropdown.Selected.Text = DropdownSettings.CurrentOption[1]
		elseif #DropdownSettings.CurrentOption == 0 then
	...
	Dropdown.Selected.Visible = true
	...
	-- ✅ Close dropdown only after text update
	if not DropdownSettings.MultipleOptions then
		task.wait(0.1)
		TweenService:Create(Dropdown, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Size = UDim2.new(1, -10, 0, 45)}):Play()
		TweenService:Create(Dropdown.Toggle, TweenInfo.new(0.7, Enum.EasingStyle.Exponential), {Rotation = 180}):Play()
